	...
	<div class="container" style="min-width: 100%">
		<div class="forms-container">
			<div class="signin-signup">
				<form action="/Assignment/login/sign-in" class="sign-in-form" method="post">
				...
				<form action="/Assignment/login/sign-up" class="sign-up-form" method="post">
		...
		<div class="panels-container">
			<div class="panel left-panel">
				<div class="content">
					<h3><a style="color: #fff;" href="/Assignment"><i class="bi bi-house-door"></i></a> New here ?</h3>
			...
			<div class="panel right-panel">
				<div class="content">
					<h3><a style="color: #fff;" href="/Assignment"><i class="bi bi-house-door"></i></a> One of us ?</h3>
