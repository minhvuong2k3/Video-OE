	...
	<body>
		<div class="container">
			<aside>
				<div class="top">
					<div class="logo">
						<a href="/Assignment/watch-product/index"><img src="<c:url value='${pageContext.request.contextPath}../../style/img/logo.png'/>" alt=""></a>
					</div>
				...
				<div class="sidebar">
					...
					<a href="/Assignment/login/index?sign-out=true">
			...
			<main>
				...
				<div id="accountList" class="recent-orders" style="display: none; margin-bottom: 30px">
					<div id="accountMana" style="display: none; margin-bottom: 10%">
						...
						<form action="/Assignment/admin/account/add" method="post">
							...
							<div class="buttons-container" style="float: right; margin-right: 5%; margin-top: 20px;">
								<button formaction="/Assignment/admin/account/add" type="submit" class="button-arounder">Create</button>
								<button formaction="/Assignment/admin/account/update" type="submit" class="button-arounder">Update</button>
								<button formaction="/Assignment/admin/account/remove" type="submit" class="button-arounder">Delete</button>
								<button formaction="/Assignment/admin/account/new" type="submit" class="button-arounder">New</button> 
							</div>
						</form>
					</div>
					<h2>Accounts List</h2>
						...
						<tbody>
							<c:forEach items="${accounts}" var="a">
								<tr>
									...
									<td class="primary"><a href="/Assignment/admin/account?id=${a.id}"><span class="material-symbols-outlined">edit</span></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					<c:if test="${empty showAllAccount}">
						<a href="/Assignment/admin/index/show-all-account">Show All</a>
					</c:if>
					<c:if test="${not empty showAllAccount}">
						<a href="/Assignment/admin/index/short-account">Shorten</a>
					</c:if>
				</div>
				<div id="productList" class="recent-orders" style="display: none; margin-bottom: 30px">
					<div id="productMana" style="display: none; margin-bottom: 10%">
						...
						<form action="/Assignment/admin/product" method="post">
							...
							<div class="buttons-container" style="float: right; margin-right: 5%; margin-top: 20px;">
								<button formaction="/Assignment/admin/product/add" type="submit" class="button-arounder">Create</button>
								<button formaction="/Assignment/admin/product/update" type="submit" class="button-arounder">Update</button>
								<button formaction="/Assignment/admin/product/remove" type="submit" class="button-arounder">Delete</button>
								<button formaction="/Assignment/admin/product/new" type="submit" class="button-arounder">New</button> 
							</div>
						</form>
					</div>
					<h2>Products List</h2>
						...
						<tbody>
							<c:forEach items="${products}" var="p">
								<tr>
									...
									<td class="primary"><a href="/Assignment/admin/product?id=${p.id}"><span class="material-symbols-outlined">edit</span></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					<c:if test="${empty showAllProduct}">
						<a href="/Assignment/admin/index/show-all-product">Show All</a>
					</c:if>
					<c:if test="${not empty showAllProduct}">
						<a href="/Assignment/admin/index/short-product">Shorten</a>
					</c:if>
				</div>
			</main>
		...
		<script type="text/javascript">
			function changeDate(){
				window.location = "/Assignment/admin/index?date="+document.getElementById('dateInput').value;
			}
		</script>
