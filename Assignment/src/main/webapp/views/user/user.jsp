...
<body style="display:flex; min-height: 100vh; flex-direction: column;">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark position-fixed w-100 top-0" style="z-index: 2;">
        <div class="container-fluid">
            <a class="navbar-brand ms-5" href="/Assignment">OE</a>
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/Assignment/watch-product/index">Home</a>
                    </li>
                    <c:forEach items="${categorys}" var="category">
		                <li class="nav-item">
	                        <a class="nav-link" href="/Assignment/watch-product/category?cate=${category}">${category}</a>
	                    </li>
		  			</c:forEach> 
		  			<li class="nav-item">
                        <a class="nav-link" href="/Assignment/favorite/index">Favorite</a>
                    </li>
                </ul>
                <ul class="navbar-nav me-5 my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <form action="/Assignment/watch-product/search" method="post" class="d-flex" role="search">
                    ...
                    <c:if test="${user.admin == true}">
                    	<li class="nav-item">
	                        <a class="nav-link" href="/Assignment/admin/index">Admin</a>
	                    </li>
                    </c:if>
                    <c:if test="${not empty user}">
                    	<li class="nav-item dropdown">
	                        ...
	                        <ul class="dropdown-menu">
	                            <li><a class="dropdown-item" href="/Assignment/profile/index">Profile</a></li>
	                            <li>
	                                <hr class="dropdown-divider">
	                            </li>
	                            <li><a class="dropdown-item" href="/Assignment/login/index?sign-out=true">Sign out</a></li>
	                        </ul>
	                    </li>
                    </c:if>
                    <c:if test="${empty user}">
                    	<li class="nav-item">
	                        <a class="nav-link" href="/Assignment/login/index">Sign in</a>
	                    </li>
                    </c:if>
                </ul>
            </div>
    	...
    	<c:if test = "${empty detail and empty favorite and empty search and empty profile}">
		            ...
		            <div class="main_item_value row col-md-12">
		            	<c:forEach items="${map[1]}" var="mapValue">
			                <div class="main_item_value_img">
			                    <a href="/Assignment/watch-product/id?id=${mapValue[0].poster}">
			                    ...
			                    <div class="btn_wrap">
							        ...
							        <div class="container">
							        	<c:if test="${mapValue[1] == false}">
							            	<a href="/Assignment/favorite/like?id=${mapValue[0].id}&ho=true"><i class="bi bi-hearts"></i></a>
							            </c:if>
							            <c:if test="${mapValue[1] == true}">
							            	<a href="/Assignment/favorite/unlike?id=${mapValue[0].id}&ho=true"><i style="color: red;" class="bi bi-hearts"></i></a>
							            </c:if>
							            <a onclick="share('${mapValue[0].poster}')" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#"><i class="bi bi-share-fill"></i></a>
							            <a href="/Assignment/watch-product/detail?id=${mapValue[0].poster}"><i class="bi bi-info-lg"></i></a>
							        </div>
							    </div>
			                </div>
			  			</c:forEach> 
		  ...
		  <c:if test = "${not empty detail and empty favorite and empty search and empty profile}">
			  <div class="col-md-12 row mb-5">
			  	<div class="col-md-6">
	              <a href="/Assignment/watch-product/id?id=${detail[0].poster}">
	              ...
	              <div class="btn_wrap" style="width: 100%;">
					<div class="container">
						<c:if test="${detail[1] == false }">
					 		<a href="/Assignment/favorite/like?id=${detail[0].id}&dt=true"><i style="opacity: 1;" class="bi bi-hearts"></i></a>
					 	</c:if>
					 	<c:if test="${detail[1] == true }">
					 		<a href="/Assignment/favorite/unlike?id=${detail[0].id}&dt=true"><i style="opacity: 1; color: red;" class="bi bi-hearts"></i></a>
					 	</c:if>
			  ...
			  <div class="col-md-12 row mb-5">
			  	<div class="col-md-6">
					  ...
					  <form action="/Assignment/watch-product/comment" class="col-md-12" method="post">
		        ...
		        <div class="main_item">
		            <div class="main_item_value row col-md-12">
			  		<c:forEach items="${favorite}" var="fa">
		                <div class="main_item_value_img">
		                    <a href="/Assignment/watch-product/id?id=${fa.video.poster}">
		                        <img src="https://img.youtube.com/vi/${fa.video.poster}/sddefault.jpg" alt="">
		                    </a>
		                    <div class="btn_wrap">
						        <span>&#10084;</span>
						        <div class="container">
						            <a href="/Assignment/favorite/unlike?id=${fa.video.id}"><i style="color: red;" class="bi bi-hearts"></i></a>
						            <a onclick="share('${fa.video.poster}')" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#"><i class="bi bi-share-fill"></i></a>
						            <a href="/Assignment/watch-product/detail?id=${fa.video.poster}"><i class="bi bi-info-lg"></i></a>
						        </div>
						    </div>
		                </div>
				  </c:forEach> 
		        ...
		        <div class="main_item">
		            <div class="main_item_value row col-md-12">
			  		<c:forEach items="${search}" var="fa">
		                <div class="main_item_value_img">
		                    <a href="/Assignment/watch-product/id?id=${fa[0].poster}">
		                    ...
		                    <div class="btn_wrap">
						        ...
						        <div class="container">
						            <c:if test="${fa[1] == false }">
								 		<a href="/Assignment/favorite/like?id=${fa[0].id}"><i class="bi bi-hearts"></i></a>
								 	</c:if>
								 	<c:if test="${fa[1] == true }">
								 		<a href="/Assignment/favorite/unlike?id=${fa[0].id}"><i style="color: red;" class="bi bi-hearts"></i></a>
								 	</c:if>
						            <a onclick="share('${fa[0].poster}')" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#"><i class="bi bi-share-fill"></i></a>
						            <a href="/Assignment/watch-product/detail?id=${fa[0].poster}"><i class="bi bi-info-lg"></i></a>
						        </div>
						    </div>
		                </div>
				  </c:forEach> 
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content bg-dark">
		      ...
		      <div class="modal-body">
		        <form action="/Assignment/profile/change-name" method="post">
		...
		<div class="modal fade" id="changePassword" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog">
		    <div class="modal-content bg-dark">
		      ...
		      <div class="modal-body">
		        <form action="/Assignment/profile/change-password" method="post">
		...
		<div class="modal fade" id="changeEmail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog">
		    <div class="modal-content bg-dark">
		      ...
		      <div class="modal-body">
		        <form action="/Assignment/profile/change-email" method="post">
    ...
    <footer class="bg-dark text-center text-white" style="">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2023 Copyright:
            <a class="text-white" href="">MinhVuongCoder</a>
        </div>
        <!-- Copyright -->
    </footer>
   ...
   <div class="modal" tabindex="-1" id="exampleModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="/Assignment/favorite/share" method="post">
			  <div class="mb-3">
